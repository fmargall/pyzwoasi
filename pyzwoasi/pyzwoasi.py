...
if   system == 'Windows':
    ...
    dllPath = os.path.join(os.path.dirname(__file__), 'lib', system, 'x64' if arch == '64bit' else 'x86', 'libASICamera2.so.1.41')
elif system == 'Darwin':
    ...
    dllPath = os.path.join(macos_base, 'arm64', 'libASICamera2.dylib.1.41') if is_arm else os.path.join(macos_base, 'x86_64', 'libASICamera2.dylib.1.41')
else:
